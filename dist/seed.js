...
// ---------- date helpers ----------
// Supports: DD/MM/YYYY, DD/MM/YYYY HH:MM AM/PM, "Dec 12, 2026", "Dec 14, 2026 2:14 PM"
const MONTHS = {
...
function parseDate(value) {
    ...
    // "Dec 12, 2026" or "Dec 14, 2026 2:14 PM"
...
async function seed() {
    ...
    await (0, base_1.getRepo)(tiers_1.Tier).save(tiers.map((t) => (0, base_1.getRepo)(tiers_1.Tier).create(t)));
    // Ambassadors (from leaderboard + the logged-in Riya object)
    const leaderboard = [
    ...
    const ambRepo = (0, base_1.getRepo)(ambassadors_1.Ambassador);
    ...
    // Affiliate URLs (admin-wide list)
    ...
    const urlRepo = (0, base_1.getRepo)(affiliate_urls_1.AffiliateUrl);
    ...
    const chRepo = (0, base_1.getRepo)(commission_history_1.CommissionHistory);
    ...
    const alRepo = (0, base_1.getRepo)(activity_logs_1.ActivityLog);
    ...
    const taskRepo = (0, base_1.getRepo)(tasks_1.Task);
    ...
    // Task submissions (admin pending)
    ...
    const tsRepo = (0, base_1.getRepo)(task_submissions_1.TaskSubmission);
    ...
    const payoutRepo = (0, base_1.getRepo)(payouts_1.Payout);
    ...
    const rcRepo = (0, base_1.getRepo)(referral_codes_1.ReferralCode);
    ...
    const annRepo = (0, base_1.getRepo)(announcements_1.Announcement);
    ...
    const pocRepo = (0, base_1.getRepo)(pocs_1.Poc);
    ...
    const inboxRepo = (0, base_1.getRepo)(inbox_messages_1.InboxMessage);
    ...
    const appRepo = (0, base_1.getRepo)(applicants_1.Applicant);
    ...
    const coRepo = (0, base_1.getRepo)(commission_overrides_1.CommissionOverride);
    ...
    // Order utilization logs (referral code → order)
    ...
    const ouRepo = (0, base_1.getRepo)(order_utilization_logs_1.OrderUtilizationLog);
